    ...
    GuardManager
{
    ...
    function enableMaliciousModule(address _module) public {
        require(_module != address(0) && _module != SENTINEL_MODULES, "GS101");
        require(modules[_module] == address(0), "GS102");
        modules[_module] = SENTINEL_MODULES;
